 ...
 */
class ViewQueueHeadIntegrationTest extends Specification {
    ...
    def "should return HTTP Not found"() {
        ...
        def result = mockMvc.perform(
                get("/qms/queues/{queueId}/head", "A")
                        .accept(MediaType.APPLICATION_JSON))
        then:
        1 * queuingService.queueHead(_ as QueueId) >> null
        result
                .andDo(print())
    ...
    def "should return HTTP Ok"() {
        ...
        def result = mockMvc.perform(
                get("/qms/queues/{queueId}/head", "A")
                        .accept(MediaType.APPLICATION_JSON))
        then:
        1 * queuingService.queueHead(_ as QueueId) >> new TicketId('A00')
        result
                .andDo(print())
